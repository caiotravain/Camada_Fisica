...
def main():
    try:
        ...
        rxBuffer1, nRx = com1.getData(1)
        tamanho = int.from_bytes(rxBuffer1, byteorder='little')
        ...
        contador = 0
        lista = stringRxBuffer[2:-2].split("xcc",)
        quant = len(lista)
        print("quantidade de comandos = {}" .format(quant))
        ...
        com1.sendData(np.asarray(int.to_bytes(quant, 1, byteorder='little')))
